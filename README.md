...
| 💰 **真实供应链数据** | 物料编码体系 · 5 种数据采集渠道(ERP/供应商/B2B/期货/合同) · 更新频率 · MOQ 限制 |
| 👥 **4 角色权限** | 选品设计师 / 供应链专员 / 运营复盘 / AI 管理员 · 菜单隔离 · 数据隔离 |
...
| 📖 **用户故事** | 5 选品设计师场景 + 3 供应链场景 + 2 运营场景 + 4 管理员场景
...
| 版本 | 日期 | 更新 |
|------|------|------|
| **v3.2** | 2026-06-24 | 6行业自适应Tech Pack / 供应链真实数据源+采集频率 / MOQ指标体系 / 移动端优化 / 完整用户故事文档 |
| **v3.1** | 2026-06-24 | 角色权限菜单隔离 / 亮色蓝白主题 / 每页用户故事 / Toast通知 / 退出确认 / 防重复导航 |
| **v3.0** | 2026-06-24 | 4角色16页面完整系统 / 工作流编排Coze风格画布 / MCP配置 / 用户管理 |
| **v2.0** | 2026-06-24 | Web GUI / FastAPI后端 / WebSocket实时Agent可视化 |
| **v1.0** | 2026-06-23 | 初始版本 / 5Agent模块 / Memory架构 / MCP骨架 / PPT方案文档
